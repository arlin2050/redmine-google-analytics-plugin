...
1. Download the plugin.  There are three supported ways:
   ...
   * Checkout the source from Git
       ...
       git clone git://github.com/arlin2050/redmine-google-analytics-plugin.git vendor/plugins/google_analytics_plugin

   * Install it using Rail's plugin installer

       script/plugin install git://github.com/arlin2050/redmine-google-analytics-plugin.git
